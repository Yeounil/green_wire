...
const faqs: Record<Category, { q: string; a: string }[]> = {
  ...
  요금: [
    {
      q: "무료로 뭘 할 수 있나요?",
      a: "회원가입 시 무료 토큰이 제공됩니다. 토큰으로 원하는 종목의 AI 분석 리포트를 생성해보세요.",
    },
    {
      q: "유료 플랜 차이가 뭔가요?",
      a: "플랜별로 제공되는 토큰 수와 분석 기능이 다릅니다. 더 많은 리포트가 필요하면 상위 플랜을 이용하세요.",
    },
    {
      q: "토큰은 어떻게 사용하나요?",
      a: "종목 페이지에서 리포트 생성 버튼을 누르면 토큰 1개가 차감되고 AI 분석 리포트가 즉시 생성됩니다.",
    },
    {
      q: "환불되나요?",
